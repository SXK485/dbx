...
export default {
  ...
  savedSql: {
    ...
    invalidName: 'The file name is invalid (illegal characters, a reserved name, or a trailing dot/space): "{name}"',
    deleteFile: "Delete SQL",
    deleteFileConfirm: "Delete “{name}”?",
    revealInFolder: "Open Containing Folder...",
    revealFailed: "Failed to open folder: {message}",
    refreshQueries: "Refresh Queries",
    queriesRefreshed: "Queries refreshed",
    queriesRefreshFailed: "Failed to refresh queries: {message}",
    pasteSqlFiles: "Paste SQL Files...",
    pastedFiles: "Pasted {count} SQL file(s)",
    noClipboardFiles: "No .sql files on the clipboard",
    pasteFilesFailed: "Failed to paste SQL files: {message}",
  ...
  sqlLibrary: {
    ...
    chooseQueriesDirectory: "Set Queries Directory (Global Default)...",
    disableQueriesDirectory: "Disable Queries Directory",
    queriesDirectorySaved: "Queries directory saved; loading existing scripts...",
    queriesDirectoryDisabled: "Queries directory disabled",
    queriesDirectoryFailed: "Failed to set queries directory: {message}",
  },
  ...
  connection: {
    ...
    savedSqlDir: "Queries directory",
    savedSqlDirPlaceholder: "C:\\Users\\<user>\\Documents\\DBX\\MySQL\\servers\\<connection>",
    savedSqlDirBrowse: "Browse...",
    savedSqlDirHint: 'Database queries for this connection are stored as real .sql files under "<dir>\\<database>\\". Leave empty to use "Documents\\DBX\\<database type>\\servers\\<connection name>" automatically, or point it at an existing Navicat queries folder to reuse your scripts.',
  ...
  contextMenu: {
    ...
    renameObjectFailed: "Failed to rename: {message}",
