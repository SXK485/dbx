...
export default withEnglishFallback({
  ...
  savedSql: {
    ...
    invalidName: "文件名无效（包含 Windows 不允许的字符、保留名称，或结尾是点/空格）：“{name}”",
    deleteFile: "删除 SQL",
    deleteFileConfirm: "确定删除“{name}”吗？",
    revealInFolder: "打开所在的文件夹...",
    revealFailed: "打开文件夹失败：{message}",
    refreshQueries: "刷新查询",
    queriesRefreshed: "查询已刷新",
    queriesRefreshFailed: "刷新查询失败：{message}",
    pasteSqlFiles: "粘贴 SQL 文件...",
    pastedFiles: "已粘贴 {count} 个 SQL 文件",
    noClipboardFiles: "剪贴板中没有 .sql 文件",
    pasteFilesFailed: "粘贴 SQL 文件失败：{message}",
  ...
  sqlLibrary: {
    ...
    chooseQueriesDirectory: "设置查询文件目录（全局默认）...",
    disableQueriesDirectory: "取消查询文件目录",
    queriesDirectorySaved: "查询文件目录已设置，正在载入现有脚本...",
    queriesDirectoryDisabled: "查询文件目录已取消",
    queriesDirectoryFailed: "设置查询文件目录失败：{message}",
    collapseAll: "全部折叠",
  },
  ...
  connection: {
    ...
    savedSqlDir: "查询保存目录",
    // 查询文件目录：留空自动使用“文档\DBX\<数据库类型>\servers\<连接名>”。
    savedSqlDirPlaceholder: "C:\\Users\\<用户名>\\Documents\\DBX\\MySQL\\servers\\<连接名>",
    savedSqlDirBrowse: "浏览...",
    savedSqlDirHint: "该连接每个数据库的查询都保存为真实 .sql 文件，位于“<目录>\\<数据库>\\”下。留空时自动使用“文档\\DBX\\<数据库类型>\\servers\\<连接名>”；也可以指向已有的 Navicat 查询目录直接复用脚本。",
    readOnlyBadge: "只读",
    proxy: "代理",
  ...
  contextMenu: {
    ...
    renameObjectFailed: "重命名失败：{message}",
